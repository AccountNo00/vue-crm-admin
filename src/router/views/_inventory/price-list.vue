					...
					<div class="card-body">
						...
						<div class="d-flex mb-2">
							...
							<select class="form-control">
								<option value=""></option>
								<option value="pc-supplier">PC SUPPLIER</option>
								<option value="cband-provider">C-BAND PROVIDER</option>
							</select>
						</div>
						<div class="d-flex mb-2">
								...
								<table class="table table-responsive custom-style">
									...
									<tbody>
										<tr v-for="(row,index) in data" :key="index">
											<td>test item</td>
											<td>1000</td>
											<td>Matagal Ma lowbat</td>
											<td>
												<b-button variant="info" class="btn-sm">Edit</b-button>
											</td>
										</tr>
									</tbody>
								</table>
